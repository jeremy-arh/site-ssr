...
export const translations = {
  en: {
    ...
    hero: {
      ...
      feature2: 'Same-Day Service',
      feature3: 'Bank-Level Security & GDPR Compliant',
    },
    chatCTA: {
      servicesTitle: "Can't find the service you need?",
    },
    // Services
    services: {
      title: 'Our Services',
      ...
      searchSubtitle: 'Find the notarization service you need. Search by name or filter by category.',
    ...
    serviceDetail: {
      ...
      relatedServicesOnlineNotary: 'Browse All Notarization Services',
      pricing: {
      ...
      whatYouReceive: {
        title: 'What You Receive After Your Notary Appointment',
        subtitle: 'A complete, ready-to-submit certified document',
        items: {
          official: 'Official notarization certificate with legal attestation',
          notaryInfo: "Notary's full name, title, and handwritten signature",
          dateRef: 'Date of certification and unique reference number',
          digitalPdf: 'Digitally signed PDF delivered to your email',
          permanentAccess: 'Permanent access from your My Notary dashboard',
        },
        cta: 'Start your notarization',
        disclaimer: '* Illustration only – not the actual document delivered. All names and details shown are fictitious and provided as examples.',
      },
      officiallyRecognized: {
        title: 'Officially Recognized in 113 Countries',
        subtitle: 'Through the Hague Apostille Convention',
        items: {
          hagueValid: 'Valid across all Hague Convention member states',
          acceptedWorldwide: 'Accepted by governments, banks, and institutions worldwide',
          noLegalization: 'No additional legalization required in most cases',
          notaryLicense: 'Notary license number included for verification',
        },
        cta: 'Start your notarization',
      },
      validForPurpose: {
        title: 'Valid for Any Official Purpose',
        subtitle: 'One document, endless possibilities',
        items: {
          bankAccount: 'Bank and investment account opening (KYC/AML)',
          visa: 'Visa and immigration applications',
          university: 'University enrollment abroad',
          property: 'Property purchases and legal proceedings',
          company: 'Company registration and business contracts',
        },
        cta: 'Start your notarization',
      },
    },
  ...
  fr: {
    ...
    hero: {
      title: 'Notariez Vos Documents en Ligne en Quelques Minutes',
      subtitle: 'Rapide, sécurisé et reconnu légalement dans le monde entier. Effectuez votre notarisation entièrement en ligne en quelques minutes seulement.',
      cta: 'Notariser maintenant',
      feature1: 'Accepté dans l\'UE et à l\'international',
      feature2: 'Service le jour même',
      feature3: 'Sécurité bancaire et conforme RGPD',
    },
    chatCTA: {
      servicesTitle: "Vous ne trouvez pas le service dont vous avez besoin ?",
    },
    services: {
      title: 'Nos Services',
      ...
      searchSubtitle: 'Trouvez le service de notarisation dont vous avez besoin. Recherchez par nom ou filtrez par catégorie.',
    ...
    serviceDetail: {
      ...
      relatedServicesOnlineNotary: 'Parcourir tous nos services de notarisation',
      pricing: {
      ...
      whatYouReceive: {
        title: 'Ce que vous recevez après votre rendez-vous de notarisation',
        subtitle: 'Un document certifié complet, prêt à être soumis',
        items: {
          official: 'Certificat de notarisation officiel avec attestation légale',
          notaryInfo: 'Nom complet, titre et signature manuscrite du notaire',
          dateRef: 'Date de certification et numéro de référence unique',
          digitalPdf: 'PDF signé numériquement envoyé par email',
          permanentAccess: 'Accès permanent depuis votre tableau de bord My Notary',
        },
        cta: 'Commencer votre notarisation',
        disclaimer: '* Illustration uniquement – ne correspond pas au document réellement délivré. Les noms et informations affichés sont fictifs et donnés à titre d\'exemple.',
      },
      officiallyRecognized: {
        title: 'Officiellement reconnu dans 113 pays',
        subtitle: 'Grâce à la Convention Apostille de La Haye',
        items: {
          hagueValid: 'Valide dans tous les États membres de la Convention de La Haye',
          acceptedWorldwide: 'Accepté par les gouvernements, banques et institutions du monde entier',
          noLegalization: 'Aucune légalisation supplémentaire requise dans la plupart des cas',
          notaryLicense: 'Numéro de licence du notaire inclus pour vérification',
        },
        cta: 'Commencer votre notarisation',
      },
      validForPurpose: {
        title: 'Valide pour tout usage officiel',
        subtitle: 'Un document, des possibilités infinies',
        items: {
          bankAccount: 'Ouverture de compte bancaire et d\'investissement (KYC/AML)',
          visa: 'Demandes de visa et d\'immigration',
          university: 'Inscription universitaire à l\'étranger',
          property: 'Achats immobiliers et procédures judiciaires',
          company: 'Création d\'entreprise et contrats commerciaux',
        },
        cta: 'Commencer votre notarisation',
      },
    },
    ...
    trustpilot: {
      ...
      timeAgo: {
        ...
        '4days': 'Il y a 4 jours',
        '5days': 'Il y a 5 jours',
        '6days': 'Il y a 6 jours',
        '7days': 'Il y a 7 jours',
  ...
  es: {
    ...
    hero: {
      title: 'Notarice Sus Documentos en Línea en Minutos',
      subtitle: 'Rápido, seguro y legalmente reconocido en todo el mundo. Complete su notarización completamente en línea en solo unos minutos.',
      cta: 'Notarizar ahora',
      feature1: 'Aceptado en la UE e internacionalmente',
      feature2: 'Servicio el mismo día',
      feature3: 'Seguridad bancaria y conforme RGPD',
    },
    chatCTA: {
      servicesTitle: '¿No encuentra el servicio que necesita?',
    },
    services: {
      ...
      searchSubtitle: 'Encuentre el servicio de notarización que necesita. Busque por nombre o filtre por categoría.',
    ...
    serviceDetail: {
      ...
      relatedServicesOnlineNotary: 'Explorar todos los servicios de notarización',
      pricing: {
      ...
      whatYouReceive: {
        title: 'Lo que recibe después de su cita de notarización',
        subtitle: 'Un documento certificado completo, listo para presentar',
        items: {
          official: 'Certificado de notarización oficial con atestación legal',
          notaryInfo: 'Nombre completo, título y firma manuscrita del notario',
          dateRef: 'Fecha de certificación y número de referencia único',
          digitalPdf: 'PDF firmado digitalmente enviado a su correo electrónico',
          permanentAccess: 'Acceso permanente desde su panel de My Notary',
        },
        cta: 'Iniciar su notarización',
        disclaimer: '* Solo ilustración – no corresponde al documento realmente entregado. Los nombres e información mostrados son ficticios y se proporcionan como ejemplo.',
      },
      officiallyRecognized: {
        title: 'Oficialmente reconocido en 113 países',
        subtitle: 'A través de la Convención de Apostilla de La Haya',
        items: {
          hagueValid: 'Válido en todos los estados miembros de la Convención de La Haya',
          acceptedWorldwide: 'Aceptado por gobiernos, bancos e instituciones de todo el mundo',
          noLegalization: 'Sin legalización adicional requerida en la mayoría de los casos',
          notaryLicense: 'Número de licencia del notario incluido para verificación',
        },
        cta: 'Iniciar su notarización',
      },
      validForPurpose: {
        title: 'Válido para cualquier propósito oficial',
        subtitle: 'Un documento, posibilidades infinitas',
        items: {
          bankAccount: 'Apertura de cuenta bancaria y de inversión (KYC/AML)',
          visa: 'Solicitudes de visa e inmigración',
          university: 'Inscripción universitaria en el extranjero',
          property: 'Compras de propiedades y procedimientos legales',
          company: 'Registro de empresas y contratos comerciales',
        },
        cta: 'Iniciar su notarización',
      },
    },
  ...
  de: {
    ...
    hero: {
      title: 'Beglaubigen Sie Ihre Dokumente Online in Wenigen Minuten',
      subtitle: 'Schnell, sicher und weltweit rechtlich anerkannt. Erledigen Sie Ihre Beglaubigung vollständig online in nur wenigen Minuten.',
      cta: 'Jetzt beglaubigen',
      feature1: 'In der EU und international anerkannt',
      feature2: 'Service am selben Tag',
      feature3: 'Bank-Level-Sicherheit & DSGVO-konform',
    },
    chatCTA: {
      servicesTitle: 'Finden Sie nicht den Service, den Sie brauchen?',
    },
    services: {
      ...
      searchSubtitle: 'Finden Sie den Notarisierungsservice, den Sie benötigen. Suchen Sie nach Name oder filtern Sie nach Kategorie.',
    ...
    serviceDetail: {
      ...
      relatedServicesOnlineNotary: 'Alle Notarisationen durchsuchen',
      pricing: {
      ...
      whatYouReceive: {
        title: 'Was Sie nach Ihrem Notartermin erhalten',
        subtitle: 'Ein vollständiges, einreichfertiges zertifiziertes Dokument',
        items: {
          official: 'Offizielles Notarisierungszertifikat mit rechtlicher Beglaubigung',
          notaryInfo: 'Vollständiger Name, Titel und handschriftliche Unterschrift des Notars',
          dateRef: 'Datum der Beglaubigung und eindeutige Referenznummer',
          digitalPdf: 'Digital signiertes PDF per E-Mail zugestellt',
          permanentAccess: 'Permanenter Zugang über Ihr My Notary Dashboard',
        },
        cta: 'Ihre Beglaubigung starten',
        disclaimer: '* Nur Illustration – entspricht nicht dem tatsächlich gelieferten Dokument. Alle angezeigten Namen und Details sind fiktiv und dienen als Beispiel.',
      },
      officiallyRecognized: {
        title: 'Offiziell anerkannt in 113 Ländern',
        subtitle: 'Durch das Haager Apostille-Übereinkommen',
        items: {
          hagueValid: 'Gültig in allen Mitgliedstaaten des Haager Übereinkommens',
          acceptedWorldwide: 'Akzeptiert von Regierungen, Banken und Institutionen weltweit',
          noLegalization: 'Keine zusätzliche Legalisierung in den meisten Fällen erforderlich',
          notaryLicense: 'Notarlizenznummer zur Überprüfung enthalten',
        },
        cta: 'Ihre Beglaubigung starten',
      },
      validForPurpose: {
        title: 'Gültig für jeden offiziellen Zweck',
        subtitle: 'Ein Dokument, endlose Möglichkeiten',
        items: {
          bankAccount: 'Eröffnung von Bank- und Anlagekonten (KYC/AML)',
          visa: 'Visa- und Einwanderungsanträge',
          university: 'Universitätseinschreibung im Ausland',
          property: 'Immobilienkäufe und Gerichtsverfahren',
          company: 'Firmenregistrierung und Geschäftsverträge',
        },
        cta: 'Ihre Beglaubigung starten',
      },
    },
  ...
  it: {
    ...
    hero: {
      title: 'Notarizza i Tuoi Documenti Online in Pochi Minuti',
      subtitle: 'Veloce, sicuro e legalmente riconosciuto in tutto il mondo. Completa la tua notarizzazione interamente online in pochi minuti.',
      cta: 'Notarizza ora',
      feature1: 'Accettato nell\'UE e a livello internazionale',
      feature2: 'Servizio lo stesso giorno',
      feature3: 'Sicurezza bancaria e conforme GDPR',
    },
    chatCTA: {
      servicesTitle: 'Non trovi il servizio di cui hai bisogno?',
    },
    services: {
      ...
      searchSubtitle: 'Trova il servizio di notarizzazione di cui hai bisogno. Cerca per nome o filtra per categoria.',
    ...
    serviceDetail: {
      ...
      relatedServicesOnlineNotary: 'Sfoglia tutti i servizi di notarizzazione',
      pricing: {
      ...
      whatYouReceive: {
        title: 'Cosa ricevi dopo il tuo appuntamento notarile',
        subtitle: 'Un documento certificato completo, pronto per essere presentato',
        items: {
          official: 'Certificato di notarizzazione ufficiale con attestazione legale',
          notaryInfo: 'Nome completo, titolo e firma autografa del notaio',
          dateRef: 'Data di certificazione e numero di riferimento univoco',
          digitalPdf: 'PDF firmato digitalmente inviato alla tua email',
          permanentAccess: 'Accesso permanente dalla tua dashboard My Notary',
        },
        cta: 'Inizia la tua notarizzazione',
        disclaimer: '* Solo illustrazione – non corrisponde al documento effettivamente consegnato. I nomi e le informazioni mostrate sono fittizi e forniti a titolo di esempio.',
      },
      officiallyRecognized: {
        title: 'Ufficialmente riconosciuto in 113 paesi',
        subtitle: 'Attraverso la Convenzione Apostille dell\'Aia',
        items: {
          hagueValid: 'Valido in tutti gli stati membri della Convenzione dell\'Aia',
          acceptedWorldwide: 'Accettato da governi, banche e istituzioni in tutto il mondo',
          noLegalization: 'Nessuna legalizzazione aggiuntiva richiesta nella maggior parte dei casi',
          notaryLicense: 'Numero di licenza del notaio incluso per la verifica',
        },
        cta: 'Inizia la tua notarizzazione',
      },
      validForPurpose: {
        title: 'Valido per qualsiasi scopo ufficiale',
        subtitle: 'Un documento, infinite possibilità',
        items: {
          bankAccount: 'Apertura di conti bancari e di investimento (KYC/AML)',
          visa: 'Richieste di visto e immigrazione',
          university: 'Iscrizione universitaria all\'estero',
          property: 'Acquisti immobiliari e procedimenti legali',
          company: 'Registrazione aziendale e contratti commerciali',
        },
        cta: 'Inizia la tua notarizzazione',
      },
    },
  ...
  pt: {
    ...
    hero: {
      title: 'Notarize Seus Documentos Online em Poucos Minutos',
      subtitle: 'Rápido, seguro e legalmente reconhecido em todo o mundo. Conclua sua notarização completamente online em apenas alguns minutos.',
      cta: 'Notarizar agora',
      feature1: 'Aceite na UE e internacionalmente',
      feature2: 'Serviço no mesmo dia',
      feature3: 'Segurança bancária e conforme RGPD',
    },
    chatCTA: {
      servicesTitle: 'Não encontra o serviço de que precisa?',
    },
    services: {
      ...
      searchSubtitle: 'Encontre o serviço de notarização de que precisa. Pesquise por nome ou filtre por categoria.',
    ...
    serviceDetail: {
      ...
      relatedServicesOnlineNotary: 'Explorar todos os serviços de notarização',
      pricing: {
      ...
      whatYouReceive: {
        title: 'O que você recebe após sua consulta notarial',
        subtitle: 'Um documento certificado completo, pronto para submissão',
        items: {
          official: 'Certificado de notarização oficial com atestação legal',
          notaryInfo: 'Nome completo, título e assinatura manuscrita do notário',
          dateRef: 'Data de certificação e número de referência único',
          digitalPdf: 'PDF assinado digitalmente enviado para seu e-mail',
          permanentAccess: 'Acesso permanente pelo seu painel My Notary',
        },
        cta: 'Iniciar sua notarização',
        disclaimer: '* Apenas ilustração – não corresponde ao documento realmente entregue. Os nomes e informações exibidos são fictícios e fornecidos como exemplo.',
      },
      officiallyRecognized: {
        title: 'Oficialmente reconhecido em 113 países',
        subtitle: 'Através da Convenção da Apostila de Haia',
        items: {
          hagueValid: 'Válido em todos os estados membros da Convenção de Haia',
          acceptedWorldwide: 'Aceito por governos, bancos e instituições em todo o mundo',
          noLegalization: 'Nenhuma legalização adicional necessária na maioria dos casos',
          notaryLicense: 'Número da licença do notário incluído para verificação',
        },
        cta: 'Iniciar sua notarização',
      },
      validForPurpose: {
        title: 'Válido para qualquer finalidade oficial',
        subtitle: 'Um documento, possibilidades infinitas',
        items: {
          bankAccount: 'Abertura de conta bancária e de investimento (KYC/AML)',
          visa: 'Solicitações de visto e imigração',
          university: 'Matrícula universitária no exterior',
          property: 'Compras de imóveis e procedimentos legais',
          company: 'Registro de empresas e contratos comerciais',
        },
        cta: 'Iniciar sua notarização',
      },
    },
